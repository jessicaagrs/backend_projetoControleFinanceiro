using APIControleFinanceiro.Controllers.v1.Usuarios;
using APIControleFinanceiro.Controllers.v1.Models;
using APIControleFinanceiro.Domain.Models.Usuarios;
using System.Text.RegularExpressions;
using static APIControleFinanceiro.Domain.Models.Database.DatabaseSettings;

namespace APIControleFinanceiro.Application.Servicos.Usuarios
{
